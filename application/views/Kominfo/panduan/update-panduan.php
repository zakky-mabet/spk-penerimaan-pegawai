      ...
      <div class="box-body" style="margin-top: 10px;">
        <div class="form-group">
          ...
          <div class="form-group">
              ...
              <div class="col-md-8">
              <input type="text"  class="form-control" autofocus name="nomor" value="<?php echo $get->nomor ?>" placeholder="Nomor">
          ...
          <div class="form-group">
              ...
              <div class="col-md-8">
              <textarea name="nama_panduan" rows="6" class="form-control" placeholder="Nama Panduan"><?php echo $get->nama_panduan ?></textarea>
